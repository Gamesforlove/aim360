...
};gdjs.SetPlayerNameCode.asyncCallback18940708 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(runtimeScene.getGame().getVariables().getFromIndex(9).getAsNumber()), (runtimeScene) => (gdjs.SetPlayerNameCode.asyncCallback18940708(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.SetPlayerNameCode.asyncCallback18948228 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.SetPlayerNameCode.localVariables);
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "MainMenu", false);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.SetPlayerNameCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(runtimeScene.getGame().getVariables().getFromIndex(9).getAsNumber()), (runtimeScene) => (gdjs.SetPlayerNameCode.asyncCallback18948228(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.SetPlayerNameCode.GDPlayerNameObjects1.length ;i < len;++i) {
    gdjs.SetPlayerNameCode.GDPlayerNameObjects1[i].getBehavior("Text").setText("Current Name: " + runtimeScene.getGame().getVariables().getFromIndex(6).getAsString());
}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("PlayerNameInput"), gdjs.SetPlayerNameCode.GDPlayerNameInputObjects1);
{runtimeScene.getGame().getVariables().getFromIndex(6).setString((( gdjs.SetPlayerNameCode.GDPlayerNameInputObjects1.length === 0 ) ? "" :gdjs.SetPlayerNameCode.GDPlayerNameInputObjects1[0].getBehavior("Text").getText()));
}{gdjs.evtTools.storage.writeStringInJSONFile("player", "name", runtimeScene.getGame().getVariables().getFromIndex(6).getAsString());
}
{ //Subevents
